...
class OTPCustomTextFieldState extends StatefulWidget {
...
class _OTPCustomTextFieldState extends State<OTPCustomTextFieldState> {
...
class OtpFieldController {
  late _OTPCustomTextFieldState _otpTextFieldState;

  void setOtpTextFieldState(_OTPCustomTextFieldState state) {
